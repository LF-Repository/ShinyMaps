...
server <- function(input, output){
  ...
  output$map <- renderLeaflet({
    leaflet() %>% 
      setView(lng = -121.771598, lat = 38.533867, zoom = 8) %>% # center the map Davies, CA
...
shapefile <- sf::st_read("C:\\Users\\recce\\OneDrive\\Documents\\NSCC_GDA_Classes\\GDAA_2000-Data_Mining_Fundamentals\\Project_1\\ShinyDashboards Maps\\ca_ag_regions.shp")
